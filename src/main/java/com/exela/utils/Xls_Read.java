...
//import com.exela.driverscript.DriverExecution;

//import driverScript.Execution;
   ...
   // public static String filename = "src/config/testcases/TestData.xlsx";
    ...
    public boolean setCellDataFormula(String sheetName,String colName,int rowNum)
    {
    	try
    	{
            ...
            if (cell == null)
                cell = row.createCell(colNum);
            cell.setCellFormula(DriverExecution.CONFIG.getProperty("Formula"));
