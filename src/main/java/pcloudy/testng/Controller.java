...
public class Controller {
	...
	public void runTestNGTest() throws Exception {
		...
		myClasses.add(new XmlClass("pcloudy.testng.DriverExecution"));
		...
		String authToken = con.authenticateUser(prop.getProperty("pCloudy_Username"),prop.getProperty("pCloudy_ApiKey"));
		...
		BookingDtoDevice[] bookedDevices = con.AppiumApis().bookDevicesForAppium(authToken, selectedDevices, Integer.parseInt(prop.getProperty("pCloudy_DurationInMinutes")), sessionName);
